...
import StudentPost from "../../components/modals/StudentPost";
          ...
          <table className="table table-hover border-separate border-spacing-x-0 border-spacing-y-3">
            <thead className="border-none">
              <tr className={`${darkClassHead(mode, "transparent")}`}>
                ...
                >
                  {lang.studentsPage2["ism"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["familya"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["yosh"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["jinsi"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["tel_raqam"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["t_username"]}
                </th>
                <th
                  scope="col"
                  className={`whitespace-nowrap py-3 capitalize bg-transparent !text-inherit border-none`}
                >
                  {lang.studentsPage2["guruh"]}
                </th>
                <th
                  className={`whitespace-nowrap py-3 bg-transparent !text-inherit border-none`}
                ></th>
